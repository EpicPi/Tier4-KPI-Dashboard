...
///
@Component(
    selector: 'red-material-progress',
    preserveWhitespace: false,
    templateUrl: 'material_progress.html',
    styleUrls: const ['red_material_progress.scss.css'],
    changeDetection: ChangeDetectionStrategy.OnPush)
class RedMaterialProgressComponent implements AfterViewInit, OnDestroy {
  ...
  RedMaterialProgressComponent(ElementRef elementRef)
