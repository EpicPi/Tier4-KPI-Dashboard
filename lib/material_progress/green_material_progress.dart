...
///
@Component(
    selector: 'green-material-progress',
    preserveWhitespace: false,
    templateUrl: 'material_progress.html',
    styleUrls: const ['green_material_progress.scss.css'],
    changeDetection: ChangeDetectionStrategy.OnPush)
class GreenMaterialProgressComponent implements AfterViewInit, OnDestroy {
  ...
  GreenMaterialProgressComponent(ElementRef elementRef)
