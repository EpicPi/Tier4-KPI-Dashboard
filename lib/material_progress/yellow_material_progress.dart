...
///
@Component(
    selector: 'yellow-material-progress',
    preserveWhitespace: false,
    templateUrl: 'material_progress.html',
    styleUrls: const ['yellow_material_progress.scss.css'],
    changeDetection: ChangeDetectionStrategy.OnPush)
class YellowMaterialProgressComponent implements AfterViewInit, OnDestroy {
  ...
  bool get useFallbackAnimation => indeterminate && false;
  ...
  YellowMaterialProgressComponent(ElementRef elementRef)
